...
class LedgerSigner:
    ...
    def verify_signature(self, block_hash: str, signature_b64: str, public_key_pem: str | None = None) -> bool:
        """
        Verify signature against block_hash.
        """
        if self.algorithm == "ed25519":
            return self._ed25519_signer.verify_signature(block_hash.encode("utf-8"), signature_b64, public_key_pem)
