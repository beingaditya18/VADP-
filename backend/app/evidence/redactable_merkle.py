...
class RedactableEvidenceMerkleTree:
    ...
    def __init__(self, evidence_data: dict[str, Any], sensitive_keys: list[str] | None = None):
    ...
    def compute_merkle_root(self) -> str:
        ...
        while len(tree_nodes) > 1:
            ...
            for i in range(0, len(tree_nodes), 2):
                parent_hash = sha256(f"0x01:{tree_nodes[i]}:{tree_nodes[i + 1]}".encode())
