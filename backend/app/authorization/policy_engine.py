"""
Nyaya-ZTA Hybrid RBAC + ABAC Policy Engine (Policy Decision Point)
===============================================================
...
class PolicyEngine:
    """Policy Decision Point (PDP) for Zero Trust Access Control."""
    ...
    def evaluate(
        ...
        """
        # Admin super-user shortcut (with audit logging)
        if user.role == "admin":
            return True, "Access granted: Admin role privilege", None
