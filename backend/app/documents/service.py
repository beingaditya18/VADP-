...
class DocumentService:
    ...
    async def upload_document(
        ...
        logger.info(
            "Document uploaded to local storage",
            extra={"doc_id": created_doc.id, "path": str(target_path), "sha256": content_hash},
        )
    ...
    async def get_document_for_download(self, doc_id: str) -> tuple[str, str, str]:
        """
        Get local file path, original filename, and MIME type for downloading.
        """
